package com.userProfileManagementApi.util;
...
public class JWTTokenProvider {
    ...
    @Value("'!A@#($0*)@*#HKSU_!#420-212&^_+!@&^*#jkllQZklioiaWNMciOBHGsFpJ-=::>JjNfYGVxa%'")
    private String secret;

    public String generateJwtToken(UserPrincipal userPrincipal) {
        String[] claims = getClaimsFromUser(userPrincipal);
        return JWT.create().withIssuer(SecurityConstant.COMPANY).withAudience(SecurityConstant.APP_NAME)
